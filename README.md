...
In order to progress in the job application, the company is asking programmers to
...
password “password” CRUD functionality (Create / Read / Update / Delete)
...
• Email notification: send email whenever new company is entered (use
Mailgun or Mailtrap) Testing with phpunit
